...
static void __attribute__((unused)) CX10_Write_Packet(uint8_t bind)
{
  ...
  case F_Q222:
    ...
    {							// F_Q282 & F_Q222
      ...
      else if (video_state & 0x20)
        video_state &= 0x01;
      flags2 |= video_state | GET_FLAG(CH7_SW, 0x10); // Channel 7 - F_Q282 picture / F_Q222 Module 2
    }
    if (CH10_SW)
      flags |= 0x80; // Channel 10 - RTH
    break;
  case DM007:
    ...
    if (CH9_SW)
      flags |= CX10_FLAG_HEADLESS; // Channel 9 - headless
    break;
  case JC3015_2:
    aileron = 3000 - aileron;
