...
static void __attribute__((unused)) E01X_send_packet(uint8_t bind)
{
  ...
  if (sub_protocol == E012)
  {
    ...
    {
      packet[1] = 0x01 | GET_FLAG(E01X_RTH_SW, E012_FLAG_RTH) | GET_FLAG(E01X_HEADLESS_SW, E012_FLAG_HEADLESS) | GET_FLAG(E01X_FLIP_SW, E012_FLAG_FLIP);
  ...
  { // E015
    ...
    else
    {
      ...
      packet[6] = arm_flags;
      packet[7] = E015_FLAG_EXPERT | GET_FLAG(E01X_FLIP_SW, E015_FLAG_FLIP) | GET_FLAG(E01X_LED_SW, E015_FLAG_LED) | GET_FLAG(E01X_HEADLESS_SW, E015_FLAG_HEADLESS) | GET_FLAG(E01X_RTH_SW, E015_FLAG_RTH);
      packet[8] = 0;
      // checksum
      packet[9] = packet[0];
  ...
  { // E016H
    ...
    else
    {
      ...
      if (val > 0x100)
        calibrate = 0;
      // flags
      packet[1] |= GET_FLAG(E016H_STOP_SW, E016H_FLAG_STOP) | (can_flip ? GET_FLAG(E01X_FLIP_SW, E016H_FLAG_FLIP) : 0) | (calibrate ? E016H_FLAG_CALIBRATE : 0);
      packet[3] |= GET_FLAG(E01X_HEADLESS_SW, E016H_FLAG_HEADLESS) | GET_FLAG(E01X_RTH_SW, E016H_FLAG_RTH);
