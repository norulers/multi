  ...
  else
  {
    ...
    case Q303:
      ...
      packet[8] = 0x03  // high rate (0-3)
                  | GET_FLAG(CH5_SW, 0x40) | GET_FLAG(CH10_SW, 0x80);
      packet[9] = 0x40 // always set
                  | GET_FLAG(CH9_SW, 0x08) | GET_FLAG(CH6_SW, 0x80) | GET_FLAG(CH7_SW, 0x10) | GET_FLAG(CH8_SW, 0x01);
    ...
    case CX35:
      ...
      packet[6] = slider >> 2;
      packet[7] = ((slider & 3) << 6) | 0x3e; // ?? 6 bit left (always 111110 ?)
