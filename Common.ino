...
void Frsky_init_hop(void)
{
  ...
  hopping_frequency[0] = 1;
  hopping_frequency[1] = 116;
  hopping_frequency[2] = 232;
}
#endif
/******************************/
...
// CC2500_WriteReg(CC2500_07_PKTCTRL1, 0x04);
// CC2500_WriteReg(CC2500_08_PKTCTRL0, 0x01);//不一样
// CC2500_WriteReg(CC2500_3E_PATABLE, 0xff);
// CC2500_WriteReg(CC2500_0B_FSCTRL1, 0x0A);//不一样
// CC2500_WriteReg(CC2500_0C_FSCTRL0, 0x00);
// CC2500_WriteReg(CC2500_0D_FREQ2, 0x5c);
// CC2500_WriteReg(CC2500_0E_FREQ1, 0x76);
// CC2500_WriteReg(CC2500_0F_FREQ0, 0x27);
// CC2500_WriteReg(CC2500_10_MDMCFG4, 0x7B);//不一样 带宽
// CC2500_WriteReg(CC2500_11_MDMCFG3, 0x61);//不一样 波特率
// CC2500_WriteReg(CC2500_12_MDMCFG2, 0x13);//不一样GFSK 30/32SYNC
// CC2500_WriteReg(CC2500_13_MDMCFG1, 0x23);
// CC2500_WriteReg(CC2500_14_MDMCFG0, 0x7a);
// CC2500_WriteReg(CC2500_15_DEVIATN, 0x51);//不一样
